...
void gdaa_stream_init(void){REG_SNDSTAT|=DS_MASTER_ENABLE; REG_SNDDSCNT|=DS_B_VOLUME_100|DS_B_RIGHT|DS_B_LEFT|DS_B_TIMER1|DS_B_FIFO_RESET; REG_DMA2CNT=0; REG_TM1CNT=0; REG_TM2CNT=0; irq_add(II_TIMER2,gdaa_stream_timer_irq); irq_enable(II_TIMER2);}
